...
function App() {
  ...
  Object.defineProperty(this, 'prop', {
    get:function() {
      var res = {};
      res = utility.merge(res, context.locals);
      res = utility.merge(res, context.utils);
      res = utility.merge(res, context.flags);
      res = utility.merge(res, context.properties);
      return res;
    },
    enumerable:true,
    configurable:true
...
App.prototype.local = function(name, value) {
  // Basically a setter for this.data
...
App.prototype.get = function(route, handler) {
  if ('string' === typeof route) && ('undefined' === typeof handler) return this.prop[route];
  if (('function' === typeof route) && (!handler)) {
    handler = route;
    route = '**';
  }
...
App.prototype.set = function(name, value) {
  // Basically go through to this.property()
  return this.propery(name, value);
};
